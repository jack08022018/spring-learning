...
public class TaskService {
	...
	private static Comparator<SessionInfo> timeoutComparator = new Comparator<SessionInfo>() {
	...
	private static PriorityQueue<SessionInfo> taskQueue = new PriorityQueue<SessionInfo>(timeoutComparator);
